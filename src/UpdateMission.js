...
const UpdateMission = props => {
    ...
    useEffect(() => {
        ...
        fetch("http://localhost:8080/ReVo_webtest/GetUsersOfAMission", requestOptions)
            .then(res => res.json())
        ...
        fetch("http://localhost:8080/ReVo_webtest/MissionQRCode?missionCode=" + missionCode)
            .then(res => res.blob())
            .then(result => {
    ...
    const updateMission = async (newMissionName, newMissionCap, newMissionStart, newMissionEnd) => {
        ...
        await fetch("http://localhost:8080/ReVo_webtest/UpdateMission", requestOptions)
    ...
    const deleteUser = async (username) => {
        ...
        await fetch("http://localhost:8080/ReVo_webtest/DeleteUserFromMission", requestOptions)
        updateChange(!change)
    }
    ...
    const addUser = async (username) => {
        ...
        await fetch("http://localhost:8080/ReVo_webtest/AddUserToMission", requestOptions)
        updateChange(!change)
    }
